...
async function refreshCloverConnection(params: {
  ...
  const upstream = await fetch(oauthConfig.refreshEndpoint, {
    method: "POST",
    headers: {
      accept: "application/json",
      "content-type": "application/json"
...
async function fetchCloverApiAccessKey(params: {
  ...
  const upstream = await fetch(params.oauthConfig.pakmsEndpoint, {
    method: "GET",
    headers: {
      accept: "application/json",
...
async function executeLiveCharge(params: {
  ...
  const { config, credentials, request, requestId, logger } = params;
...
async function executeLiveRefund(params: {
  ...
  const { config, credentials, request, requestId, providerPaymentId } = params;
